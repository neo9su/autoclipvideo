...
if has_pytest:
    result = subprocess.run(
        [sys.executable, '-m', 'pytest', 'tests/test_asr_config.py', 'tests/test_gpu_disk_policy.py', 'tests/test_gpu_service_regressions.py', 'tests/test_qianchuan_learning.py', 'tests/test_qianchuan_upload.py', 'tests/test_reclip_batch.py', 'tests/test_resumable_reclip.py', '-v', '--tb=short', '-x'],
...
run_gate listener_diagnostics python -m pytest tests/test_service_manager.py -q
