...
_SCHEME_POOL = [
    {
        ...
        "desc_hint": "第一/二人称，从具体社交场景切入，引出产品，2-3句产品亮点，1句互动提问。120-180字。",
    },
    {
        "type": "自我改变",
        "desc": "切入角度：想要改变、找到了适合自己的造型的自我觉醒感。情绪基调：治愈、释然、焕然一新。",
        "title_hint": "如「终于找到适合我的发型了」「换了这款发型后整个人都不同了」",
        "desc_hint": "从情绪触点切入（累了/想改变/一直找不到合适的），引出产品，结合字幕亮点，120-180字。",
    },
    {
        "type": "场合穿搭",
        "desc": "切入角度：某个具体场合（约会/面试/婚礼/旅行/毕业季/聚餐），这款假发帮你搞定造型。情绪基调：实用、精准、场景感强。",
        "title_hint": "如「这款发型赴约刚刚好」「面试当天换了这款，整个人精神多了」",
        "desc_hint": "用场景代入，说明为什么这个场合选这款，再展开产品亮点，120-180字。",
    },
    {
        "type": "细节种草",
        "desc": "切入角度：某个工艺/颜色渐变/发丝质感让人心动的细节。情绪基调：精致、有眼光、发现美好。",
        "title_hint": "如「这个发色渐变处理真的太细腻了」「仔细看这个发丝，假发能做到这种程度」",
        "desc_hint": "从最打动人的一个细节展开，描述质感/工艺/颜色，再延伸到整体效果，120-180字。",
    },
    {
        "type": "产品介绍",
        "desc": "切入角度：专业、清晰地介绍这款假发的核心参数和使用场景，帮粉丝做决策。情绪基调：专业、有说服力。",
        "title_hint": "如「这款Bob头到底有多仙」「详解这款假发的3个优点」",
        "desc_hint": "介绍款式/颜色/材质/佩戴感/适合场景，只写真实参数，禁止效果承诺，末尾1句适合人群+互动。120-180字。",
    },
    {
        "type": "使用教学",
        "desc": "切入角度：手把手教佩戴/搭配/护理技巧，让人觉得「我也能做到」。情绪基调：亲切、实用、有用。",
        "title_hint": "如「手把手教你戴出自然感」「一招让假发更服帖」",
        "desc_hint": "引出痛点，结合字幕中的技巧步骤，动作感强、口语化，末尾说效果+互动提问。120-180字。",
    },
    {
        "type": "价值催单",
        "desc": "切入角度：从产品价值/工艺/性价比切入，自然引导粉丝点小黄车下单。情绪基调：理性种草，行动引导。",
        "title_hint": "如「这个工艺这个价格，真的很值」「直播间被问最多的款来了」",
        "desc_hint": "1句自然引入价值，2-3句核心卖点，1-2句引导小黄车，绝对禁止「最后X单/限时/仅剩」等虚假紧迫感。100-150字。",
    },
    {
        "type": "疑问引发",
        "desc": "切入角度：用疑问句/反问句吊起好奇心，让人忍不住点进来看答案。情绪基调：好奇、探索、有悬念。",
        "title_hint": "如「这款发型凭什么这么火？」「为什么买假发要选这个颜色？」",
        "desc_hint": "标题抛出问题，描述给出答案，结合产品亮点和字幕内容，末尾再抛一个互动问题。120-180字。",
    },
]
